...
### Changed
- **OIDC Configuration:** Configured repository and bugs metadata in package.json.
- **NPM Automation:** Created GitHub Actions workflow for automatic publishing to NPM using OpenID Connect (OIDC) Trusted Publishers.
